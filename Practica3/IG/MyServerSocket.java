...
public class MyServerSocket extends ServerSocket {
	...
	public void execute(JTextArea msg, DefaultListModel<String> lm, ConcurrentHashMap<String, String> writen)
			throws IOException {
		while (true) {
			select.select();
	...
	private void connect(SelectionKey key, JTextArea msg, DefaultListModel<String> lm,
			ConcurrentHashMap<String, String> writen) throws IOException {
